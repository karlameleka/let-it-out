...
import { assignThoughtRecordTool } from "@/lib/therapist-actions";
import type { TherapistClient } from "@/lib/therapist-data";
import { Button } from "@/components/ui";

export default function SendThoughtRecordForm({ clients }: { clients: TherapistClient[] }) {
  const [state, formAction, pending] = useActionState(assignThoughtRecordTool, undefined);
