const en = {
  ...
  counseling: {
    ...
    notSureLink: "Not sure who to pick?",
    quizPrompt: "What are you looking for?",
    concernStress: "Stress or burnout",
    concernDepression: "Feeling low or depressed",
    concernAnxiety: "Anxious or overwhelmed",
    concernEmotional: "Trouble managing emotions",
    concernRelationship: "Relationship or intimacy concerns",
    quizLanguagePrompt: "Which language would you prefer to speak in?",
    quizLanguageAny: "No preference",
    quizBack: "Back",
  ...
  auth: {
    ...
    aboutYouHint: "Helps us understand who we're serving — collected once, at signup.",
    birthYear: "Birth year",
    gender: "Gender",
    country: "Country",
    referralSource: "How did you hear about us?",
    serviceInterests: "What services are you interested in?",
